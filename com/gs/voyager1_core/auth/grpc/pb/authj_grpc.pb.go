...
func (c *authServiceClient) GrantedAuthority(ctx context.Context, in *Policy, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
	err := c.cc.Invoke(ctx, "/com.gs.voyager1_core.auth.grpc.pb.AuthService/GrantedAuthority", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) GetUser(ctx context.Context, in *Authentication, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/com.gs.voyager1_core.auth.grpc.pb.AuthService/GetUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthService_GrantedAuthority_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.gs.voyager1_core.auth.grpc.pb.AuthService/GrantedAuthority",
	}
...
func _AuthService_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.gs.voyager1_core.auth.grpc.pb.AuthService/GetUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.gs.voyager1_core.auth.grpc.pb.AuthService",
